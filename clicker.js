...
const CLICK_QUOTES = [
  ...
  '"My doctor said I have chronic dogged."',
  '"I put dogged on my CV. Got hired immediately."',
  '"Google: did you mean dogged? Yes. Always yes."',
  '"My WiFi password is dogged. And also my bank PIN."',
  '"Sigve didn\'t walk so we could run. He dogged."',
  '"I told my mom I\'m a professional dogger. She hung up."',
  '"Shakespeare\'s lost play: Much Ado About Dogged."',
  '"Plot twist: the meaning of life was dogged all along."',
  '"My Tinder bio just says dogged. 100% match rate."',
  '"NASA called. They found dogged on Mars."',
  '"I failed the exam. Every answer was dogged."',
  '"My sleep paralysis demon just whispers dogged."',
  '"The Geneva Convention doesn\'t cover this level of dogged."',
  '"Officer, I was going 120 in a 60 because dogged."',
  '"I showed my grandma this game. She disowned me."',
  '"Elon wants to put dogged on the blockchain."',
  '"My cat judged me. Then typed dogged."',
  '"Breaking: scientists discover dogged is contagious."',
  '"I haven\'t touched grass since I found dogged."',
  '"Just applied for citizenship in Dog Nation. Wish me luck."',
  '"My autocorrect changed everything to dogged. I\'m keeping it."',
  '"Fun fact: the Norwegian word for dogged is dogged."',
  '"I tried explaining dogged to my parents. They called a priest."',
  '"My fitness goal is 10,000 doggeds per day."',
  '"Ancient hieroglyphs translated: dogged dogged dogged."',
  '"The last thing I\'ll say on my deathbed: dogged."',
  '"This isn\'t a game. It\'s a dogged-based religion."',
  '"911, what\'s your emergency? dogged."',
  '"I told Siri to play dogged. She played this game."',
  '"The real dogged was the friends we dogged along the way."',
  '"My landlord raised rent because of excessive dogged."',
  '"The dog at the park looked at me and said dogged."',
  '"ChatGPT refuses to say dogged this many times."',
  '"I\'ve been clicking for so long my mouse filed for divorce."',
  '"Hogwarts sorting hat: DOGGED."',
  '"The FBI watchlist just says \'dogged enthusiast.\'"',
  '"I sneezed and it came out as dogged."',
  '"My tombstone will read: They dogged."',
  '"I went to confession. My sin? Not enough dogged."',
  '"The restraining order says 500 feet from dogged. I can\'t stop."',
  '"My therapist plays this game now. We\'re both doomed."',
  '"Alexa, play dogged. *this game opens*"',
];
